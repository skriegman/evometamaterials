...
from read_write_vxd import write_vxd, read_vxd, remove_vxd
from HomProp2D import GetHomProp2D_PlaneStress
...
class SoftbotRobot(MOORobotInterface):
    ...
    def compute_work(self, test=True, **kwargs):
        ...
        # # for voxcraft:
        # write_vxd(self.phenotype, self.run_dir, self.get_seq_num())
        # self.fitness = read_vxd(self.run_dir, self.get_seq_num(), "fitness_score")
        # remove_vxd(self.run_dir, self.get_seq_num())
